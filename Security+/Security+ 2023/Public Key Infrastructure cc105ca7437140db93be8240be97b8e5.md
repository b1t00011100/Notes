...
- **Certificates :** Digitally-signed electronic documents that binds a public key with a user’s identity.
- **X.509 :** Standard used PKI for digital certificates and contains the owners/users information and the certificate authority’s information.
...
- **Subject Alternate Name (SAN) :** Allows a certificate owner to specify additional domains and IP addresses to be supported.
...
- **X.690** uses **BER, CER** and **DER** for encoding.
    ...
    - **Canonical Encoding Rules (CER) :** A restricted version of the BER that allows only the use of only one encoding type.
...
- When dealing with digital certificates , we come across few different file-types
    - Privacy-enhanced Electronic Mail (.pem, .cer, .crt or .key)
    - Public Key Cryptographic System #12 (.p12)
    - Personal Information Exchange (.pfx)
    - Public Key Cryptographic Systems #7 (.p7b)
    

### Certificate Authorities

- **Registration Authority :** Used to verify information about a user prior to requesting, that a certificate authority issues the certificate.
